        ...
        <div id="featured" className='hero-body'>
            <div className="container">
                        ...
                        <div className="card columns " style={{marginBottom: '40px'}}>
                             <div className="card-description column is-half text-left pt-0" style={{boxShadow: 'none',backgroundColor: 'transparent', display: 'flex', justifyContent: 'start', alignItems: 'center'}}>
                                <div>
                            ...
                            <div className="card-description column is-half pt-0">
                                <div>
