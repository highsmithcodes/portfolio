...
const Featured: React.FC = () => {
    ...
    const projectx = [
        ...
        {id: 7, title: 'Basement Brew', content: 'Headless Social Website for Home Brewers using AWS DynamoDB, AWS Amplify, Typescript, React, Redux, TailwindCSS, and Sass, deployed on Heroku', languages: 'Typescript, React, Sass, TailwindCSS, AWS, Heroku', git: 'https://github.com/highsmithcodes/basementbrew', link: 'https://calm-citadel-57835-a56a50f8f306.herokuapp.com/', thumbnail: 'https://github.com/highsmithcodes/portfolio/assets/17016293/f0221283-cb36-49c4-b75e-3701430592bc'},
