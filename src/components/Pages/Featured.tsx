...
const Featured: React.FC = () => {
    ...
    const projectx = [
        ...
        {id: 4, title: 'Cannabis Benchmarks', content: 'E-Commerce Store built in Wordpress, with React, SASS, PHP, hosted on WPengine with Cloudflare', languages: 'ReactJS, PHP, Sass', link: 'https://www.cannabisbenchmarks.com/', thumbnail: 'https://github.com/highsmithcodes/portfolio/assets/17016293/f266ab87-ec70-4869-8a93-f1093a4e7ec1'},
